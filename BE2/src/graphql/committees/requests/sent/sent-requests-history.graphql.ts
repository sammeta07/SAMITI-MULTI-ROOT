...
export const sentRequestsHistoryTypes = `
  type SentRequestsHistoryItem {
    committeeId: Int!
  ...
  type SentRequestsHistoryResponse {
    data: [SentRequestsHistoryItem!]!
  }
`;
...
export const sentRequestsHistoryResolvers = {
  Query: {
    async sentRequestsHistory(_: any, __: any, context: any) {
