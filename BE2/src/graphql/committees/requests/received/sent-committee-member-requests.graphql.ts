...
export const sentCommitteeMemberRequestsTypes = `
  type SentCommitteeMemberRequestItem {
    committeeId: Int!
  ...
  type SentCommitteeMemberRequestsResponse {
    data: [SentCommitteeMemberRequestItem!]!
  }
`;

export const sentCommitteeMemberRequestsQueryFields = `
  sentCommitteeMemberRequests: SentCommitteeMemberRequestsResponse!
`;
...
export const sentCommitteeMemberRequestsResolvers = {
  Query: {
    async sentCommitteeMemberRequests(_: any, __: any, context: any) {
      ...
      const rows = await query<any[]>(
        ...
        SELECT
         ...
         WHERE crr.requester_user_id = ?
           AND crr.request_role = 'COMMITTEE_MEMBER'
           AND (
