...
export const receivedCommitteeAdminRequestsTypes = `
  ...
  type ReceivedCommitteeAdminRequestsResponse {
    data: [ReceivedCommitteeAdminRequestItem!]!
  }
`;

export const receivedCommitteeAdminRequestsQueryFields = `
  receivedCommitteeAdminRequests: ReceivedCommitteeAdminRequestsResponse!
`;

export const receivedCommitteeAdminRequestsResolvers = {
  Query: {
    async receivedCommitteeAdminRequests(_: any, __: any, context: any) {
      ...
      const rows = await query<any[]>(
        `WITH latest_requests AS (
          ...
          WHERE request_role = 'COMMITTEE_ADMIN'
