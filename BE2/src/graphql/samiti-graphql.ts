...
import { sentCommitteeAdminRequestsTypes, sentCommitteeAdminRequestsQueryFields, sentCommitteeAdminRequestsResolvers } from './committees/requests/sent/sent-committee-admin-requests.graphql';
import { sentCommitteeMemberRequestsTypes, sentCommitteeMemberRequestsQueryFields, sentCommitteeMemberRequestsResolvers } from './committees/requests/sent/sent-committee-member-requests.graphql';
import { sentRequestsHistoryTypes, sentRequestsHistoryQueryFields, sentRequestsHistoryResolvers } from './committees/requests/sent/sent-requests-history.graphql';
...
import { eventVoteTypes, eventVoteQueryFields, eventVoteMutationFields, eventVoteResolvers } from './events/details/voting/event-vote.graphql';
import { eventInterestTypes, eventInterestQueryFields, eventInterestMutationFields, eventInterestResolvers } from './events/details/voting/event-interest.graphql';
import { updateEventVotingModeTypes, updateEventVotingModeMutationFields, updateEventVotingModeResolvers } from './events/details/voting/update-event-voting-mode.graphql';
...
export const typeDefs = `
  ...
  ${receivedCommitteeMemberRequestsTypes}
   ...
   ${sentCommitteeAdminRequestsTypes}
   ${sentCommitteeMemberRequestsTypes}
   ${sentRequestsHistoryTypes}
  ...
  ${programDetailsTypes}
   ...
   type Query {
    ...
    ${sentCommitteeAdminRequestsQueryFields}
    ${sentCommitteeMemberRequestsQueryFields}
    ${sentRequestsHistoryQueryFields}
    ${accountQueryFields}
...
export const resolvers = {
  Query: {
    ...
    ...sentCommitteeAdminRequestsResolvers.Query,
    ...sentCommitteeMemberRequestsResolvers.Query,
    ...sentRequestsHistoryResolvers.Query,
