...
@Component({
  selector: "app-committee-admin-requests",
  standalone: true,
  imports: [
    CommonModule,
    MatTableModule,
...
export class CommitteeAdminRequestsComponent {
  ...
  private loadData(): void {
    ...
    this.service.getReceivedCommitteeAdminRequests().subscribe({
      next: (data) => this.requests.set(data || []),
      error: (err: any) => console.error("Failed to load admin requests:", err),
  ...
  approveRequest(committeeId: string, userId: string): void {
    const dialogData: ConfirmDialogData = {
      ...
      message: "Are you sure you want to accept this admin request?",
      confirmText: "Accept",
      cancelText: "Cancel",
    };
  ...
  rejectRequest(committeeId: string, userId: string): void {
    const dialogData: ConfirmDialogData = {
      ...
      message: "Are you sure you want to reject this admin request?",
      confirmText: "Reject",
      cancelText: "Cancel",
    };
